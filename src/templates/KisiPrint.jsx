...
export default function KisiPrint({ activeSiswa, kisiData }) {
  ...
  return (
    <div className="hidden print:block w-full max-w-4xl mx-auto bg-white text-black font-serif text-sm">
      <div className="flex items-center gap-4 mb-5 border-b-[3px] border-black pb-3">
        ...
        <div className="flex-1 text-center pr-20">
          <h1 className="text-[17px] font-bold uppercase tracking-wider mb-1 leading-tight">
            Kisi-Kisi Penilaian Akademik
          </h1>
          <h2 className="text-[17px] font-bold uppercase tracking-wider mb-0 leading-tight">
      ...
      <p className="text-justify mb-4 leading-relaxed indent-8">
        Bersama ini kami sampaikan kisi-kisi dan materi pokok yang akan diujikan
        kepada ananda <span className="font-bold">{activeSiswa?.nama}</span>.
        Kami mohon bantuan Ayah/Bunda untuk turut serta mendampingi dan memantau
        proses belajar ananda di rumah.
      </p>
      ...
      <table className="w-full border-collapse border border-black mb-6">
        ...
        <tbody className="align-top">
          <tr>
            ...
            <td className="border border-black py-2 px-3 font-semibold text-center">
              {kisiData?.mata_pelajaran || "-"}
            </td>
            <td className="border border-black py-2 px-3 text-justify min-h-[150px]">
              {kisiData?.materi || "Belum ada materi."}
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <div className="flex justify-end pr-12">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="font-bold mt-1 underline">Nina Rahilah, S.Pd.</p>
        </div>
      </div>
      <style
